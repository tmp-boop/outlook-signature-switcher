Office.onReady(() => {
  ...
  document.getElementById("internalEditor").innerHTML =
    Office.context.roamingSettings.get("internalSignature") || "";
  document.getElementById("externalEditor").innerHTML =
    Office.context.roamingSettings.get("externalSignature") || "";
