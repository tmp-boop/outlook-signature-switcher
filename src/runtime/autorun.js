...
// Signaturerne er skrevet direkte af brugeren selv i taskpane'et og ligger
// kun i brugerens egen postkasse (roamingSettings) - ingen fælles skabelon,
// ingen netværkskald, ingen fil i Git.
...
async function applySignature() {
  ...
  if (!settings.internalSignature && !settings.externalSignature) {
    // Intet skrevet endnu i indstillingerne - rør ikke ved mailen.
    return;
  }
